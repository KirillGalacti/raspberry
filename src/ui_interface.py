...
"}")
        ...
        self.btn_page_1 = QPushButton(self.header_frame)
...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 762, 586))
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 762, 586))
